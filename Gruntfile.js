...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      // Default Tasks
      // TEST BUILD
      grunt.registerTask('default', ['build']); grunt.registerTask('dev', ['build']); grunt.registerTask('server', ['express', 'open', 'watch']); grunt.registerTask('build', ['clean', 'jshint', 'csslint', 'copy', 'concat', 'uglify', 'cssmin', 'imagemin', 'processhtml']);
    };